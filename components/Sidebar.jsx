    ...
    items: [
      {
        ...
        icon: FiMonitor,
        href: "/it-inventory/computers",
      },
      {
        name: "Router Inventory",
        icon: FiWifi,
        href: "/it-inventory/routers",
      },
      {
        name: "Printer Inventory",
        icon: FiPrinter,
        href: "/it-inventory/printers",
      },
      {
        name: "Scanner Inventory",
        icon: FiMonitor,
        href: "/it-inventory/scanners",
      },
      {
        name: "Ethernet Inventory",
        icon: FiWifi,
        href: "/it-inventory/ethernet",
      },
      {
        name: "Machine Inventory",
        icon: FiCpu,
        href: "/it-inventory/machines",
      },
      {
        name: "UPS Inventory",
        icon: FiServer,
        href: "/it-inventory/ups",
      },
      {
        name: "Monitor Inventory",
        icon: FiMonitor,
        href: "/it-inventory/monitors",
      },
    ],
  },
];
