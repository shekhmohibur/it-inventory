...
export default function HardwareSpecTable({
  title,
  breadcrumb,
  storageKey,
  nameLabel,
  ...
  const handleSubmit = (e) => {
    ...
    if (!form.name.trim()) {
      setError(`Please enter a ${nameLabel.toLowerCase()}.`);
      return;
    }
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="space-y-5 px-6 py-6">
                ...
                <div>
                  ...
                  <p className="mt-1.5 text-[11px] text-slate-400">
                    Optional internal notes or specifications.
                  </p>
